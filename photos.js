...
function createEventListeners() {
   //declarevariable for document element with id of leftarrow, which is in the html document
   var leftarrow = document.getElementById("leftarrow")

    //add an event handler to the specifie document (leftarrow)
    //the leftArrow() function will be executed when the user clicks the left navigation arrow button
    leftarrow.addEventListener("click", leftArrow, false);

 //declarevariable for document element with id of rightarrow, which is in the html document
   var rightarrow = document.getElementById("rightarrow")

    //add an event handler to the specifie document (rightarrow)
    //the rightArrow() function will be executed when the user clicks the right navigation arrow button
    rightarrow.addEventListener("click", rightArrow, false);
    
    //decalre a variable for the element fiveButton
